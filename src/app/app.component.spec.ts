...
describe('AppComponent', () => {
  ...
  it('cvv/cvc validation should work', async(() => {
    ...
    const app = fixture.componentInstance;
    app.ngOnInit();
    app.paymentForm.controls['cardCVVNumber'].setValue("677");
    expect(app.paymentForm.controls['cardCVVNumber'].valid).toBeTruthy();
  }));
  ...
  it('submit button should display the failure message', async(() => {
    ...
    app.paymentForm.controls['expirationYear'].setValue("2017");
    app.paymentForm.controls['cardCVVNumber'].setValue("6776");
    app.submitForm();
